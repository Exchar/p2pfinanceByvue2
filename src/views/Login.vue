        ...
        ? this.$axios
            ...
            .then(res => {
              ...
              if (res.data.code !== "200") {
                ...
                let shortCutsIcon = this.getShortCutsIcon;
                let shortCutsColor = this.getShortCutsColor;
                  ...
                  shortCuts.forEach(v => {
                    if (v.path != "/home") {
                      temp.push({
                        path: v.path,
                        title: v.name,
                        icon: this.randomChoice(shortCutsIcon),
                        bgColor: this.randomChoice(shortCutsColor)
                      });
                    }
                  });
                  return temp;
