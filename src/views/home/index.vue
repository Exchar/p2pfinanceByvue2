  ...
  <div class="contentMain">
    <div>
      ...
      >
        ...
        <el-col :span="2" v-for="item in actionMenuInit" :key="item.index" class="colItem" >
            <div class="actionMenuItem" style="text-align: center" @click="linkGo(item.linkTo)">
              <div style="text-align: center" class="iconOUt" :style="'background-color:'+item.bgColor">
...
export default {
  ...
  computed: {
    ...mapGetters(["getShortcuts", "getMenuData", "getShortcutsAll","getHeaderTabs"]),
    actionMenuInit() {
  ...
  methods: {
    ...
    ...mapMutations(["addshortcut","addshortcut","saveLeftMenu", "saveTabItem", "changeNowAct"])
  },
  created() {
